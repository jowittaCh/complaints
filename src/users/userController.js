...
const {createUser , logInUser ,updateUserInfo, updatePassword, fetchUserInfo , deleteUser, getAccessToken, } =require("./userService");
...
const deleteAcc = async(req,res)=>{
   ...
   const getAccess=async(req,res)=>{
    try{
        console.log("im in getAccess controller function");
